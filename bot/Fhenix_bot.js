...
const TELEGRAM_TOKEN = process.env.FHENIX_TELEGRAM_TOKEN;
const Fhenix_RPC = "https://api.helium.fhenix.zone";

// Initialize ethers.js provider
const provider = new ethers.JsonRpcProvider(Fhenix_RPC);
...
Feel free to explore the Fhenix network with these features! 💻
  `;
