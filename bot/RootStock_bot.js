...
const PORT = process.env.PORT || 3006; // Define port for the server
const app = express();
...
const TELEGRAM_TOKEN = process.env.ROOTSTOCK_TELEGRAM_TOKEN;
const Rootstock_RPC = "https://mycrypto.testnet.rsk.co";
...
Feel free to explore the Rootstock network with these features! 💻
  `;
...
module.exports = { RootStockBotFunction };
