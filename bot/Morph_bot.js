...
const Morph_RPC = "https://rpc-holesky.morphl2.io";

// Initialize ethers.js provider
const provider = new ethers.JsonRpcProvider(Morph_RPC);
...
Feel free to explore the Morph network with these features! 💻
  `;
...
module.exports = { MorphBotFunction };
