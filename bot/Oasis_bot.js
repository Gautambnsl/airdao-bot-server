...
const PORT = process.env.PORT || 3005; // Define port for the server
// const app = express();
...
const TELEGRAM_TOKEN = process.env.OASIS_TELEGRAM_TOKEN;
const Oasis_RPC = "https://sapphire.oasis.io";

// Initialize ethers.js provider
const provider = new ethers.JsonRpcProvider(Oasis_RPC);
...
Feel free to explore the Oasis network with these features! 💻
  `;
...
module.exports = { oasisBotFunction };
